"""drop blog + blog_categories tables (AI Content Factory removed)
...
def downgrade() -> None:
    # Recreate minimally (matches the original b2c3d4e5f6a7 schema) so the chain
    # remains reversible; the models no longer exist in the app.
    op.create_table(
        "blog_categories",
